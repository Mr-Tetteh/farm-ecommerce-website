            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>Our Gallery</h1>
                        <p>Enter into a world of freshness,eat well and fresh everyday, empower farmers!.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="special-menu text-center">
                        <div class="button-group filter-button-group">
							...
							<button data-filter=".podded-vegetables">Root vegetables</button>
							<button data-filter=".root-and-tuberous">Tuberous</button>
                            <button data-filter=".root-and-tuberous">Dairy Products</button>
                            <button data-filter=".root-and-tuberous">Animal Produce </button>
                        </div>
                    </div>
                </div>
            </div>
